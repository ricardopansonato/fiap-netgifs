...
public class DataLoader implements ApplicationRunner {
	...
	@Autowired
	public DataLoader(UserRepository userRepository, ImageRepository imageRepository, CategoryRepository categoryRepository) {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		category1.setName("Comédia");
		categoryRepository.save(category1);
		
		Category category2 = new Category();
		category2.setName("Terror");
		...
		image.setUrl("https://media3.giphy.com/avatars/100soft/WahNEDdlGjRZ.gif");
